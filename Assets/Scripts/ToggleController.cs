...
public class ToggleController : MonoBehaviour 
{
	...
	public void Toggle(bool toggleStatus)
	{
		...
		if(toggleStatus)
		{
            ...
            //DEFTXR_UI_Manager.Instance.isSupine = false;
            //DEFTXR_UI_Manager.Instance.isProne = true;
        }
		else 
		{
            ...
            //DEFTXR_UI_Manager.Instance.isSupine = true;
            //DEFTXR_UI_Manager.Instance.isProne = false;
        }
