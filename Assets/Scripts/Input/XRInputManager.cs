    ...
    public class XRInputManager : InputManager
    {
        ...
        private class SingleHand
        {
            ...
            public void Update()
            {
                ...
                controller.TryGetFeatureValue(CommonUsages.triggerButton, out data.PrimaryButtonDown);
                controller.TryGetFeatureValue(CommonUsages.triggerButton, out data.SecondaryButtonDown);
